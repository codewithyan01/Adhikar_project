...
export const BhashiniToggle: React.FC<Props> = ({
  selectedLanguage,
  onLanguageChange,
  voiceEnabled,
  onToggleVoice
  ...
  return (
    <div className="flex items-center gap-2 bg-slate-900/90 border border-slate-800 rounded-xl px-2.5 py-1 shadow-sm">
      ...
      <div className="flex items-center gap-1.5 pr-2 border-r border-slate-800">
        ...
        <span className="text-[10px] font-extrabold uppercase tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-indigo-400">
          भाषिणी
        </span>
      </div>
      ...
      {/* Non-blocking Pre/Post Indicator */}
      {isIndic && (
